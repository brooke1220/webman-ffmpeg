...
class HLSExporter extends MediaExporter
{
    ...
    */
    ...
    /**
     * @var \Brooke1220\WebmanFfmpeg\Exporters\PlaylistGenerator
     */
     ...
     *
     * @param \Brooke1220\WebmanFfmpeg\Exporters\PlaylistGenerator $playlistGenerator
     * @return self
     */
     ...
     * @param \Brooke1220\WebmanFfmpeg\Filesystem\Disk $disk
     * @param integer $key
     * @return array
     */
     ...
     *
     * @param \Brooke1220\WebmanFfmpeg\Filesystem\Media $media
     * @return self
     */
     ...
     *
     * @param string $path
     * @throws \Brooke1220\WebmanFfmpeg\Exporters\NoFormatException
     ...
     *
     * @param string $path
     * @return \Brooke1220\WebmanFfmpeg\MediaOpener
     */
